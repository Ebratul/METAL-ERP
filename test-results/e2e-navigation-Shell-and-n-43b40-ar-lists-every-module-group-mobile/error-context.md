...
Locator: getByRole('navigation', { name: 'Module navigation' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('navigation', { name: 'Module navigation' })
...
- main:
  ...
  - region "Financial summary":
    ...
    - group "Cash Flow Forecast view":
      ...
      - button "Table view"
    - text: Inflow Outflow
    - application: W1 W2 W3 W4 W5 W6 W7 W8 W9 W11 W13 $0 $700K $1.4M $2.1M $2.8M
  ...
  - region "Market performance":
    ...
    - group "Sales by Country view":
      ...
      - button "Table view"
    - list:
      - listitem: Bangladesh $5.45M
      - listitem: China $4.12M
      - listitem: Vietnam $3.28M
      - listitem: India $2.85M
      - listitem: Turkey $2.24M
      - listitem: Indonesia $1.68M
      - listitem: Cambodia $1.42M
      - listitem: Others $3.53M
  ...
  - region "Inventory and supply":
    ...
    - group "Stock Aging view":
      - button "Chart view" [pressed]
      - button "Table view"
    - application: 0–30 d 31–60 d 61–90 d 91–180 d 180+ d $0 $2M $4M $6M $8M
  ...
  - region "Margin, energy and logistics":
    ...
    - application: Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec 0 350K 700K 1.05M 1.4M
  ...
  - region "Cost structure":
    ...
    - application: Jan Feb Mar Apr Jun Jul Aug Sep Oct Nov Dec $0 $6.5M $13M $19.5M $26M
